...
#caixa de bigodes multiplo (comparar 2 vï¿½riaveis (continua - nominal ou ordinal))
...
# ^peso = 3253.986 + -8.395 * distancia (por cada km q se acrescenta ï¿½ distancia, acrescenta -8.395kg no peso)
